...
{
    [SerializeField]
    [Tooltip("Button that opens the blower menu.")]
    Button m_CreateBubblesButton;
    

    /// <summary>
    /// Button that opens the create menu.
    /// </summary>
    public Button createBubblesButton
    {
        get => m_CreateBubblesButton;
        set => m_CreateBubblesButton = value;
    }


    [SerializeField]
    [Tooltip("The menu with all the Blower objects.")]
    GameObject m_SelectBlowerMenu;

    /// <summary>
    /// The menu with all the blower objects.
    /// </summary>
    public GameObject selectBlower
    {
        get => m_SelectBlowerMenu;
        set => m_SelectBlowerMenu = value;
    }
    ...
    Animator m_SelectBlowerMenuAnimator;
    ...
    {
        get => m_SelectBlowerMenuAnimator;
        set => m_SelectBlowerMenuAnimator = value;
    }
    ...
    void OnEnable()
    {
        m_CreateBubblesButton.onClick.AddListener(ShowMenu);
    ...
    void OnDisable()
    {
        m_ShowSelectBlowerMenu = false;
        m_CreateBubblesButton.onClick.RemoveListener(ShowMenu);
    ...
    void Update()
    {
        ...
        else
        {
            ...
            m_CreateBubblesButton.gameObject.SetActive(true);
        }
    ...
    void ShowMenu()
    {
        m_ShowSelectBlowerMenu = true;
        m_SelectBlowerMenu.SetActive(true);
        if (!m_SelectBlowerMenuAnimator.GetBool("Show"))
        {
            m_SelectBlowerMenuAnimator.SetBool("Show", true);
        }
    ...
    {
        m_SelectBlowerMenuAnimator.SetBool("Show", false);
        m_ShowSelectBlowerMenu = false;
        AdjustARDebugMenuPosition();
    }
    ...
    {
        if (m_CreateBubblesButton.TryGetComponent<RectTransform>(out var buttonRect))
        ...
        if (m_SelectBlowerMenu.TryGetComponent<RectTransform>(out var menuRect))
            m_SelectBlowerMenuOffset = new Vector2(0f, menuRect.anchoredPosition.y + menuRect.rect.height + 10f);
        else
            m_SelectBlowerMenuOffset = new Vector2(0f, 345f);
    }
    ...
    void AdjustARDebugMenuPosition()
    {
        ...
        {
            Vector2 menuOffset = m_ShowSelectBlowerMenu ? m_SelectBlowerMenuOffset : m_ObjectButtonOffset;
